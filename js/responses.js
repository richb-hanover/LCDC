...
function formatResponse(resp) {
  ...
  <br />  <br />
  <dt>Takeaway:</dt>  <dd>${resp.Takeaway}</dd>
  <dt>Like about Lyme:</dt>  <dd>${resp.Like}</dd>
  <dt>Desirable Changes:</dt>  <dd>${resp.Change}</dd>
   <dt>How address:</dt>  <dd>${resp["How-address"]}</dd>
  <dt>Other thoughts:</dt>  <dd>${resp.Other}</dd>
  </dl>
  `;
}
